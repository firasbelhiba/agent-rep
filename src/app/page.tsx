    ...
    <div className="min-h-screen bg-black text-white overflow-hidden">
        ...
        <div className="relative z-20 max-w-[1140px] mx-auto px-6 lg:px-[50px] pt-[200px] pb-[100px]">
          <div className="max-w-[560px]">
            ...
            <p className="text-[18px] text-[#9b9b9d] max-w-[460px] mb-12 leading-relaxed font-light animate-fade-in-delay-2">
              The decentralized trust layer for autonomous AI — inspired by the <span className="text-[#b47aff]">ERC-8004</span> standard. Real feedback, real validation, real trust — all recorded immutably on Hedera.
            </p>
      ...
      <section className="py-32 bg-[#0a0a1a]/50">
        <div className="max-w-[1140px] mx-auto px-6 lg:px-[50px]">
          ...
          <h2 className="text-center mb-6">
            Powered by{" "}
            <span className="text-[#b47aff]">open standards</span>
          </h2>
          <p className="text-center text-[16px] text-[#9b9b9d] font-light max-w-2xl mx-auto mb-16">
            AgentRep recreates the <span className="text-[#b47aff]">ERC-8004</span> three-registry architecture (Identity, Reputation, Validation) on Hedera using HCS — the first native implementation outside Ethereum.
          </p>
      ...
      <footer className="border-t border-white/[0.06] py-16 bg-black">
        <div className="max-w-[1140px] mx-auto px-6 lg:px-[50px]">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
            ...
            <div>
              <h4 className="text-[14px] text-[#b47aff] font-medium mb-4">Network</h4>
              <ul className="space-y-3">
