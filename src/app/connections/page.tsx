    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-[1200px] mx-auto px-6 lg:px-[50px] py-8 pt-[120px]">
        ...
        <details className="mb-8 group">
          <summary className="cursor-pointer flex items-center gap-2 text-[#b47aff] hover:text-[#c99aff] transition-colors text-sm font-medium">
            ...
            <span>📹 Need help? Watch how to use this</span>
          </summary>
          <div className="mt-3 rounded-xl overflow-hidden border border-[#2a2a3e] bg-[#0d0d15]">
            <video
              controls
              preload="metadata"
              ...
              poster=""
            >
              <source src="https://res.cloudinary.com/dhbol6euq/video/upload/v1774040483/0320_1_1_veuhvv.mov" type="video/mp4" />
